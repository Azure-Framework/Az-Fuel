...
Use `Az-Framework/modules/fuel` through the main `Az-Framework` resource instead of installing this repository as a separate FiveM resource.

## Migration

1. Remove `ensure Az-Fuel` from `server.cfg`.
